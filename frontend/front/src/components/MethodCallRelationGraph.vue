                        ...
                        <el-container class="formbody">
                            <el-form ref="form" :model="selectTestForm" label-width="80px">
                                ...
                                <el-form-item label="新版本">
                                    <el-select v-model="regression.info.newVersion" placeholder="选择要回归的新版本" @visible-change="showfilelist" @change="fileListChange">
                                        <el-option
                                ...
                                <el-form-item>
                                    <el-button size="small" type="success" @click="regressionAnalyze" :disabled="regression.disabled">分析</el-button>
                                </el-form-item> 
                            </el-form>
                        </el-container>
                    </el-card>
